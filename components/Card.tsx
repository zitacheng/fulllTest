...
export const Card = (props: CardProps) => {
  ...
  return (
    <View accessibilityRole='none' accessibilityLabel='userCard' accessible style={styles.card}>
      ...
      {props?.edit == true && (
        <TouchableOpacity
          style={props?.user?.checked == true ? styles.check : styles.uncheck}
          onPress={() => {
