...
function App(): React.JSX.Element {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <InputUser setSearch={setSearch} search={search} setUsers={setUsers} getUser={getUser}/>
      <Menu edit={edit} setEdit={setEdit} users={users} setUsers={setUsers} selectAll={selectAll} setSelectAll={setSelectAll} />
      <VirtualizedList
